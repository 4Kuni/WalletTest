import { 
    Heading, Square, Table, TableCaption, TableContainer, Tbody, Td, Text, Tfoot, Th, Thead, Tooltip, Tr
                ...
                <Table variant = {'striped'} colorScheme = {'orange'}>
                    ...
                    <Thead>
                        <Tr>
                            ...
                            <Th sx = {thStyle} isNumeric>Amount</Th>
                        </Tr>
                    </Thead>
                    ...
                    <Tbody>
                        ...
                        transactions.map(transaction => (
                            <Tr key = {transaction.hash} h = {isPhoneHardware(hardware) ? 220 : 120}>
                                <Td>
                                ...
                                <Td isNumeric>
                                    <Tooltip label = {ethParse(transaction.value)} placement = {'bottom-end'}>
                                        <Text
                                            maxW = {'100px'} 
                                            noOfLines={1} 
                                            display = {'block !important'}
