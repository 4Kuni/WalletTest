...
import { IConnectWalletContentProps } from '../../../../types/Types';
            ...
            <ModalBody>
                { 
                    ...
                    <Center flexDirection={'column'} gap = {5}>
                        ...
                        <Box textAlign = {'center'} fontSize={isPhoneHardware(hardware) ? '30px': '20px'}>Connecting...</Box>
                    </Center>
                    :
                    <Flex
                        direction = {'column'}
                    >
                        ...
                        >
                            <Flex direction = {'row'} width = {'100%'} gap = {4} alignItems = {'center'}>
                                ...
                                <Text fontSize = {isPhoneHardware(hardware) ? '24px': '16px'}>MetaMask</Text>
                                <Spacer/>
