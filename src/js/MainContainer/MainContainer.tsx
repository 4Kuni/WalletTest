...
function MainContainer(): JSX.Element {
  ...
  return (
    <Flex
      direction={
        isPhoneHardware(hardware) ? "column" : { base: "column", lg: "row" }
      }
      bg={"walletBackground"}
    ...
    >
            ...
            <>
              ...
              >
                <Image
                  ...
                  src={
                    "https://freeiconshop.com/wp-content/uploads/edd/menu-outline.png"
                  }
                />
              </Button>
              <SideBarDrawer
      ...
      <Flex
        ...
        borderColor={"sideBarBackground"}
      >
        {mainContent === "wallet" ? <Wallet /> : <Transactions />}
      </Flex>
    </Flex>
  );
}
